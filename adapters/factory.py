...
_LOCAL_REGISTRY: Dict[str, str] = {
    ...
    # GAP-3 FIX: llava now routes to LLaVAOllamaAdapter instead of
    # QwenOllamaAdapter. Using QwenOllamaAdapter for LLaVA caused constant
    # JSON parse failures because the Qwen-specific structured prompt format
    # (XML-style output markers, strict JSON schema) is foreign to LLaVA's
    # plain instruction-following training. Fix: dedicated adapter with
    # LLaVA-compatible prompts. Covers llava, llava-llama3, llava-phi3, etc.
