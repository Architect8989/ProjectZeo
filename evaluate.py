...
def evaluate_final_screenshot(guideline):
    ...
    response = openai.chat.completions.create(
        ...
        presence_penalty=0,  # PATCH: removed — unusual penalties distort JSON evaluation output
        frequency_penalty=0,  # PATCH: removed — see above
        temperature=0.0,  # PATCH (audit Risk #9): deterministic evaluation — 0.7 caused non-reproducible pass/fail
    )
